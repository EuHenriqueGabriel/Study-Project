...
def createButtons(janela, gameStatus, title_, playersScore):
    ...
    resetButton = Button(janela, text='PLAY', padx=10, pady=10)
...
def main():
    ...
    playersScore[0].grid(column=0, row=4)
    playersScore[1].grid(column=2, row=4)
